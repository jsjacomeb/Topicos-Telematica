        ...
        while True:
            ...
            if command.startswith("cd"):
                ...
                try:
                    ...
                    # Esperar la confirmación del servidor para comenzar a enviar el contenido
                    response = client_socket.recv(1024).decode()
                    if response == "Ready to receive":
                        # Enviar el contenido del archivo
                        client_socket.sendall(file_data)
                        client_socket.send(b'END')  # Señal de fin de archivo
...
def main():
    ...
    client_socket.connect(("192.168.1.36", 54321))
